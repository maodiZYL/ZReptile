...
type Wutuobang3 struct {
	Members []struct {
		ID string `json:"id"`
	} `json:"members"`
}

type tongxing4 struct {
...
func Tongxing3(bang string, bang2 string) { //bang为结构体，接收的是结构体
